...
It's not recommended to set your execution peer count any higher than `100` in grown out networks. For genesis validators, execution peer counts of `30` are enough already, while `50` is the default for a larger growing network. Just think about an evenly spread network and how you can favor decentralization, while being energy and data efficient.
