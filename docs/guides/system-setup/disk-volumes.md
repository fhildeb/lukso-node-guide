...
Further details about blocks and resizing can be found on the [Storage Specification](/docs/theory/node-operation/storage-specification.md) page of the [**🧠 Theory Section**](/docs/theory/preparations/node-specifications.md) section.
