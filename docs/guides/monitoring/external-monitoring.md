...
The consensus explorer is considered the main status page for validators when it comes to monitoring uptime, withdrawals, block proposals, and earnings. You can either use the

- [**Withdrawal Dashboard:**](https://explorer.consensus.mainnet.lukso.network/validators/withdrawal-dashboard) Summarized overview for all validators linked to the same withdrawal address.
- [**Validators API:**](https://dora.explorer.mainnet.lukso.network/api/swagger/index.html) Detailed validator incices analytics in **JSON** format.

The links of both versions can be bookmarked in your browser.

<Tabs groupId="validator-checks">
  <TabItem value="dashboard" label="Withdrawal Dashboard" default>

  <Tabs groupId="network">
  <TabItem value="mainnet" label="Mainnet" default>

Open the LUKSO Mainnet's [**Dora Explorer**](https://explorer.consensus.mainnet.lukso.network/validators/withdrawal-dashboard) and input your withdrawal address too see all linked validators, their total uptime rate and balance, and various withdrawal metrics.

![Dora Withdrawal Overview](/img/guides/monitoring/explorer-pages-4.png)

</TabItem> <TabItem value="testnet" label="Testnet">

Open the LUKSO Testnet's [**Dora Explorer**](https://explorer.consensus.testnet.lukso.network/validators/withdrawal-dashboard) and input your withdrawal address too see all linked validators, their total uptime rate and balance, and various withdrawal metrics.
...
If you have multiple withdrawal addresses, open another window and repeat the process.

:::

</TabItem> <TabItem value="api" label="Validator API">
